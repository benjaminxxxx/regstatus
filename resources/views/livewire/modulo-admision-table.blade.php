<div>
    ...
    <div class="mb-5 shadow-lg bg-white px-6 py-3 overflow-hidden rounded-lg col-span-1">
        ...
        <div class="flex text-indigo-600 mb-4">
            ...
            <p class="text-lg font-bold ml-2">MÓDULOS DE ADMISIÓN</p>
        </div>
        <form action="#" wire:submit.prevent="store()">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-2">
                    <label for="nombre_modulo" required class="{{$input_label}}">NOMBRE DEL MÓDULO</label>
                    <input type="text" required wire:model.defer="nombre_modulo" class="{{$input_class}} uppercase">
                </div>
            </div>
            <div>
