            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    <p class="title">
                        ...
                        <span style="font-size: 11px">PROTOCOLO PARA LA VACUNACIÓN CONTRA LA COVID-19 PARA ADOLECENTES DE 12 A 17 AÑOS DE EDAD.</span>
                        ...
                        EXPRESIÓN DE CONSENTIMIENTO <b>INFORMADO</b></p>
                </td>
            </tr>
            ...
            <tr>
                <td  colspan="2">
                    <table width="600px" style="margin-top:120px">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="no_line_botton"> Que </div>
                                <div class="linea_bottom" style="width:250px">{{$hijo}} </div>
                    ...
                    SI 
                     ...
                     NO 
                        ...
                        <img src="{{public_path('images/checkyes.png')}}" style="max-width:{{$ac}}" alt="">
                            ...
                            <img src="{{public_path('images/checkno.png')}}" style="max-width:{{$ac}}" alt="">
                            @endif
                            doy mi consentimiento para que el personal de salud aplique la vacuna contra la COVID-19.
                    </p>
                </td>
            </tr>
            <tr>
