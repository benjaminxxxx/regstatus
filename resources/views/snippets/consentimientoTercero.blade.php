...
<style>
    ...
    <x-form-modal submit="procesaroSino" wire:model="mostrarconsentimientoTercera" maxWidth="max-tablet">
                                    ...
                                    <tr>
                                        <td width="55%">
                                            <div class="firma firmap firmap1" style="min-height: 5rem">
                                                <div id="signatureparent">
                                                    <div id="signaturesign7" style="max-width:298px;background: #efefef;"></div>
                                                </div>
                                                <div id="tools"></div>
                                            </div>
                                        ...
                                        <td width="45%">
                                            <div class="firma relative" style="min-height: 5rem">
                                                ...
                                                @endif
                                                <input type="radio" wire:model="firmartraije" wire:change="getdoc1firmaTres('1')" name="firmartraije" class="absolute right-0 top-10" value="consentimiento">
                                            </div>
                                    ...
                                    <tr>
                                        <td width="55%">
                                            <div class="firma firmap firmap2" style="min-height: 5rem">
                                                <div id="signatureparent">
                                                    <div id="signaturesign8" style="max-width:298px;background: #efefef;"></div>
                                                </div>
                                                <div id="tools"></div>
                                            </div>
                                            <p class="sub">Firma o huella digital del paciente</p>
                                        ...
                                        <td width="45%">
                                            <div class="firma relative" style="min-height: 5rem">
                                                @if ($firmartraije=='desistimiento')
                                                    <img src="{{asset('firmas/'.Auth::user()->firma)}}" class="h-20 m-auto" alt="">
                                                @endif
                                                <input type="radio" wire:model="firmartraije" wire:change="getdoc1firmaTres('2')" name="firmartraije" class="absolute right-0 top-10" value="desistimiento">
                                            </div>
        ...
        <x-slot name="footer">
            <x-secondary-button type="button" wire:click.pevent="$toggle('mostrarconsentimientoTercera')" wire:loading.attr="disabled">
                CANCELAR
            </x-secondary-button>
            <x-button type="button" id="signatureTercera">
