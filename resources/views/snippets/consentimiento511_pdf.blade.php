            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    <p class="title">
                        ...
                        <span style="font-size: 11px">PROTOCOLO PARA LA VACUNACIÓN CONTRA LA COVID-19 PARA PERSONAS DE 5 A 11 AÑOS DE EDAD</span>
                    ...
                    <table width="600px" style="margin-top:120px">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <div class="linea_bottom" style="width:390px">{{$mamacondni}} </div>
                                <div class="no_line_botton">de condición como</div> 
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="linea_bottom" style="width:250px">{{$parientede}} </div>
                                <div class="no_line_botton"> con DNI: </div>
                                <div class="linea_bottom" style="width: 112px; text-align: center;">{{$campo_documento_child}}</div>
                ...
                <td colspan="2">
                    ...
                    <p>SI 
                        ...
                        NO 
                            ...
                            <img src="{{public_path('images/checkno.png')}}" style="max-width:{{$ac}}" alt="">
                            @endif
                            tiene síntomas compatibles con COVID-19; o ha dado positivo a una prueba a COVID-19, en las últimas dos semanas; o estoy en seguimiento clínico por COVID-19.
                    </p>
                    ...
                    <p class="text-justify">
                        En ese sentido, he sido informado (a) de los beneficios y Ios potenciales efectos adversos de la Vacuna contra la COVID-19 y, resueltas todas Ias preguntas y dudas al respecto, consciente de mis derechos y en forma voluntaria. en cumplimiento de la normativa vigente; 
                    </p>
                    <p>
                    SI 
                     ...
                     NO 
                        ...
                        <img src="{{public_path('images/checkyes.png')}}" style="max-width:{{$ac}}" alt="">
                            ...
                            <img src="{{public_path('images/checkno.png')}}" style="max-width:{{$ac}}" alt="">
                            @endif
                            doy mi consentimiento para que el personal de salud aplique la vacuna contra la COVID-19 a mi  {{$tutor}} que es menor de edad.
                    </p>
                </td>
            </tr>
            <tr>
                    ...
                    <table class="w-full layout-fixed" style="table-layout: fixed">
                        ...
                        <tr>
                            <td width="50%" style="padding-right: 20px">
                                ...
                                <p class="sub">Firma o huella digital del padre/madre, tutor, o familiar mayor de edad</p>
                                <p class="mt-3">
                    ...
                    <table class="w-full">
                        ...
                        <tr>
                            <td width="50%" style="padding-right: 20px">
                                ...
                                <p class="sub">Fima o huella digital del padre/madre. tutor, o familiar mayor de edad</p>
                                <p class="mt-3">
