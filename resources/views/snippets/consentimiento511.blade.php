...
@include('snippets.css')
    ...
    <x-form-modal submit="procesar511" wire:model="mostrarconsentimiento511" maxWidth="max-tablet">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <p class="title" style="font-size: 11px">PROTOCOLO PARA LA VACUNACIÓN CONTRA LA COVID-19 PARA PERSONAS DE 5 A 11 AÑOS DE EDAD.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="title">ANEXO N°01</p>
                                <p class="title">EXPRESIÓN DE CONSENTIMIENTO INFORMADO</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <p class="text-justify">
                                    ...
                                    NO (<span><input type="radio" required wire:model.defer="child_documento2_pre3" name="doc2pre3" value="NO"></span>) doy mi consentimiento para que el personal de salud me aplique la vacuna contra el COVID-19 a mi  <input type="text" class="txttituloapoderado" />  que es menor de edad
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td width="55%">
                                            <div class="firma firmap firmap1" style="min-height: 5rem">
                                                <div id="signatureparent">
                                                    <div id="signaturesign5111" style="max-width:298px;background: #efefef;"></div>
                                                </div>
                                                <div id="tools"></div>
                                            </div>
                                        ...
                                        <td width="45%">
                                            <div class="firma relative" style="min-height: 5rem">
                                                ...
                                                @endif
                                                <input type="radio" wire:model="firmartraije" wire:change="getdoclafirma('generar-firma-511','1')" name="firmartraije" class="absolute right-0 top-10" value="consentimiento">
                                            </div>
                                    ...
                                    <tr>
                                        <td width="55%">
                                            <div class="firma firmap firmap2" style="min-height: 5rem">
                                                <div id="signatureparent">
                                                    <div id="signaturesign5112" style="max-width:298px;background: #efefef;"></div>
                                                </div>
                                                <div id="tools"></div>
                                            </div>
                                            <p class="sub">Firma o huella digital del padre/madre, tutor, o familiar mayor de edad
                                        ...
                                        <td width="45%">
                                            <div class="firma relative" style="min-height: 5rem">
                                                @if ($firmartraije=='desistimiento')
                                                    <img src="{{asset('firmas/'.Auth::user()->firma)}}" class="h-20 m-auto" alt="">
                                                @endif
                                                <input type="radio" wire:model="firmartraije" wire:change="getdoclafirma('generar-firma-511','2')" name="firmartraije" class="absolute right-0 top-10" value="desistimiento">
                                            </div>
        ...
        <x-slot name="footer">
            <x-secondary-button type="button" wire:click.pevent="$toggle('mostrarconsentimiento511')" wire:loading.attr="disabled">
                CANCELAR
            </x-secondary-button>
            <x-button type="button" id="signature511">
